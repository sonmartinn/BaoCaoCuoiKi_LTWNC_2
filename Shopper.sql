...
CREATE TABLE Accounts (
    ...
    Password NVARCHAR(255) NOT NULL,  -- Lưu mật khẩu đã được mã hóa
  
);

INSERT INTO Accounts (Username, Email, Password)
VALUES ('oanhle', 'lethioanh27d@gmail.com', 'Abc123!@#');
go
...
SELECT * FROM Accounts WHERE Username = 'oanhle' AND Password = 'Abc123!@#'